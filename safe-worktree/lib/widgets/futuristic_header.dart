...
class _FuturisticHeaderState extends State<FuturisticHeader>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final t = _anim.value;
        final color1 =
            Color.lerp(const Color(0xFF00FFD5), const Color(0xFF7C4DFF), t)!;
        final color2 = Color.lerp(
            const Color(0xFF0AB9FF), const Color(0xFFFF7CDA), (t + 0.5) % 1.0)!;
        return Container(
          height: widget.preferredSize.height,
          padding: const EdgeInsets.only(top: 28, left: 20, right: 20),
          decoration: BoxDecoration(
            gradient: LinearGradient(colors: [
              color1.withAlpha((0.12 * 255).round()),
              color2.withAlpha((0.08 * 255).round())
            ...
            boxShadow: [
              BoxShadow(
                  color: color1.withAlpha((0.06 * 255).round()),
                  blurRadius: 24.0,
                  spreadRadius: 1.0,
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: color2.withAlpha((0.5 * 255).round()),
                        blurRadius: 12,
                        spreadRadius: 1)
                  ],
                ),
