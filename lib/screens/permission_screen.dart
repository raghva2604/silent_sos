    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(colors: [Color(0xFF05050A), Color(0xFF071029)], begin: Alignment.topCenter, end: Alignment.bottomCenter),
        ),
        child: SafeArea(
          child: Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Permission tiles
                  _permissionTile('SMS', _permissionStatuses['SMS'] ?? false, 0),
                  _permissionTile('Contacts', _permissionStatuses['Contacts'] ?? false, 1),
                  _permissionTile('Location', _permissionStatuses['Location'] ?? false, 2),
                  _permissionTile('Notifications', _permissionStatuses['Notifications'] ?? false, 3),
                  const SizedBox(height: 18),
                  ScaleTransition(
                  ...
                  if (!_allPermissionsGranted)
                    FuturisticButton(onPressed: () => openAppSettings(), style: FuturisticButtonStyle.secondary, height: 40, child: const Text('Open App Settings')),
                ],
              ),
            ),
          ),
